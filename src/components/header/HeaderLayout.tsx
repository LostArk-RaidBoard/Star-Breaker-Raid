...
import MHeaderLayout from '@/components/header/mobile/MHeaderLayout'
      ...
      <nav className='flex hidden h-full w-full items-center justify-between md:flex'>
        ...
        <div className='flex items-center justify-center gap-4'>
          <Link
            ...
            className='flex items-center justify-center gap-2 rounded-md text-lg font-semibold transition-colors hover:border-blue-600 hover:text-blue-600'
          >
            가이드
