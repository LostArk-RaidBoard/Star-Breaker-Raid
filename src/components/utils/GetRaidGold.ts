export default function GetRaidGold(raidName: string) {
  const raidGoldMap: { [key: string]: number } = {
    ...
    '1막 에기르 노말 1관문': 7500,
    '1막 에기르 노말 2관문': 15500,
    '1막 에기르 노말 1관문 더보기': -3200,
    '1막 에기르 노말 2관문 더보기': -5300,

    // 베히모스
    '베히모스 노말 1~2관문': 18500,
    '베히모스 노말 1관문': 6000,
    '베히모스 노말 2관문': 12500,
    '베히모스 노말 1관문 더보기': -2200,
    '베히모스 노말 2관문 더보기': -4100,

    // 에키드나
    '서막 에키드나 하드 1~2관문': 18500,
    '서막 에키드나 하드 1관문': 6000,
    '서막 에키드나 하드 2관문': 12500,
    '서막 에키드나 하드 1관문 더보기': -2200,
    '서막 에키드나 하드 2관문 더보기': -4100,

    '서막 에키드나 노말 1~2관문': 14500,
    '서막 에키드나 노말 1관문': 5000,
    '서막 에키드나 노말 2관문': 9500,
    '서막 에키드나 노말 1관문 더보기': -2200,
    '서막 에키드나 노말 2관문 더보기': -3400,

    '서막 에키드나 싱글 1~2관문': 11600,
    '서막 에키드나 싱글 1관문': 4000,
    '서막 에키드나 싱글 2관문': 7600,
    '서막 에키드나 싱글 1관문 더보기': -800,
    '서막 에키드나 싱글 2관문 더보기': -1650,
